...
function Correo3() {
    var respuesta = "";
    object = document.getElementById("Email3");
    valueForm = object.value;
...
function valida() {
    ...
    $('#Apellidos').css("border", "2px solid #fff");
    $('#Email').css("border", "2px solid #fff");
    $('#Telefono').css("border", "2px solid #fff");
    $('#TelefonoMovil').css("border", "2px solid #fff");
    $('#Password').css("border", "2px solid #fff");
    $('#RepPassword').css("border", "2px solid #fff");
        ...
        if ($('#Apellidos').val().length > 0) {
            if ($('#Email').val().length > 0) {
                if ($('#Telefono').val().length > 0) {
                    if ($('#TelefonoMovil').val().length > 0) {
                        if ($('#Password').val().length > 0) {
                            if ($('#RepPassword').val().length > 0) {
                                if (Correo() == "ok") {
                                    respuesta = "ok";
                                } else {
                                ...
                                $('#RepPassword').css("border", "2px solid red");
                                respuesta = "Repite tu password";
                            }
                        }
                        else {
                        ...
                        $('#TelefonoMovil').css("border", "2px solid red");
                        respuesta = "Coloca tu Teléfono movil";
                    }
                }
                else {
                    $('#Telefono').css("border", "2px solid red");
                    respuesta = "Coloca tu Teléfono";
                }
            }
            else {
                $('#Email').css("border", "2px solid red");
            ...
            respuesta = "Coloca tus Apellidos";
        }
    } else {
...
function Correo2() {
    var respuesta = "";
    object = document.getElementById("email2");
    valueForm = object.value;
...
function CorreoRegistrar() {
    var respuesta = false;
    object = document.getElementById("R_Email");
    valueForm = object.value;
...
function CorreoCliente() {
    var respuesta = false;
    object = document.getElementById("Cliente_Correo");
    valueForm = object.value;
